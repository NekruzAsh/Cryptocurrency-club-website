      ...
      <div className="max-w-[1240px] m-auto items-center text-center">
        <div className="mb-12 mt-12 md:mt-0">
          <h2 className="text-[#cfcfcf] mb-2">
            <span className=" text-[#FF204E]">//</span> Check out our latest lab
            research
          </h2>
        ...
        <div className="flex justify-center">
          <div className="carousel carousel-center max-w-[400px] md:max-w-2xl lg:max-w-4xl p-4 space-x-4 bg-[#191a1e] rounded-box">
            <div id="item1" className="carousel-item">
              <Link
                href="https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4541401"
                target="_blank"
              >
                <img
                  src="/images/1.png"
            ...
            <div id="item2" className="carousel-item">
              <Link
                href="https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4757280"
                target="_blank"
              >
                <img
                  src="/images/2.png"
            ...
            <div id="item3" className="carousel-item">
              <Link
                href="https://scholarspace.manoa.hawaii.edu/items/dd70e48a-3e50-4f9f-83f4-d5a97a54146f"
                target="_blank"
              >
                <img
                  src="/images/3.png"
        ...
        <div className="flex justify-center w-full py-2 gap-2">
          <a
            href="#item1"
            className="btn bg-[#191a1e] btn-xs hover:text-[#FF204E] transform duration-300"
          >
            1
          </a>
          <a
