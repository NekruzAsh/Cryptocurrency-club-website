...
const Navbar = () => {
  return (
    <div className="navbar fixed backdrop-filter backdrop-blur-lg bg-opacity-30 bg-[#1c1d21] top-10 left-0 right-0 w-[380px] md:w-[600px] lg:w-[800px] mx-auto rounded-full">
      ...
      <div className="navbar-end">
        <div className="dropdown">
          ...
          <ul tabIndex={0} className="menu menu-sm dropdown-content right-0 mt-3 z-[1] p-2 shadow backdrop-filter backdrop-blur-lg bg-opacity-30 bg-[#1c1d21] rounded-box w-52">
